...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2019-04-14 06:23:15 UTC -->
  ...
  <rdf:Description rdf:about="#Reaction_13">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4981" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Compartments[Skeletal_muscle_cells]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_4979" name="k2" value="0.001"/>
        </ListOfConstants>
        <KineticLaw function="Function_14" unitType="Default" scalingCompartment="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Compartments[Skeletal_muscle_cells]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_69">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Event_0">
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2019-04-14T00:04:12Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
  </rdf:Description>
</rdf:RDF>
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=Glycolysis - ICMB1 exercise,Reference=Time> > 20
        </TriggerExpression>
        <ListOfAssignments>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Compartments[Skeletal_muscle_cells],Vector=Metabolites[oxygen],Reference=InitialConcentration"/>
  ...
  <ListOfPlots>
    <PlotSpecification name="plot_0" type="Plot2D" active="0" taskTypes="">
    ...
    <PlotSpecification name="at rest" type="Plot2D" active="1" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        ...
        <PlotItem name="[oxygen]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Compartments[Skeletal_muscle_cells],Vector=Metabolites[oxygen],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[pyruvate]|Time" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
