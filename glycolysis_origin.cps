...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2019-04-17 13:45:59 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Compartments[compartment],Vector=Metabolites[triose_phosphate_isomerase],Reference=InitialConcentration"/>
  ...
  <ListOfPlots>
    ...
    <PlotSpecification name="enzyme ~ pyruvate (25s)" type="Plot2D" active="0" taskTypes="">
      <Parameter name="log X" type="bool" value="0"/>
      <Parameter name="log Y" type="bool" value="0"/>
      <ListOfPlotItems>
        <PlotItem name="[pyruvate]|[triose_phosphate_isomerase]_0" type="Curve2D">
          ...
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Compartments[compartment],Vector=Metabolites[triose_phosphate_isomerase],Reference=InitialConcentration"/>
            <ChannelSpec cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Compartments[compartment],Vector=Metabolites[pyruvate],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
