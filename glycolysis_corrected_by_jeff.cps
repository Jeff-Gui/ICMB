...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2019-04-07 15:24:22 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_25">
    <dcterms:created>
      ...
      <ModelValue key="ModelValue_26" name="kf_[S]_to_[H]" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_9">
    <dcterms:created>
      ...
      <Reaction key="Reaction_10" name="[H] lactic_acid to pyruvate" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_10">
    <dcterms:created>
      ...
      <Reaction key="Reaction_11" name="[H]glyconeogenesis" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_12">
    <dcterms:created>
      ...
      <Reaction key="Reaction_14" name="[S]pyruvate to lactic_acid" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_14">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_4980" name="k1" value="100"/>
          <Constant key="Parameter_4979" name="k2" value="0.01"/>
        </ListOfConstants>
        <KineticLaw function="Function_14" unitType="Default" scalingCompartment="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Compartments[Skeletal_muscle_cells]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_69">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_15">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Values[kf_\[S\]_to_\[H\]]" value="1" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Reactions[\[H\] lactic_acid to pyruvate]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Reactions[\[H\] lactic_acid to pyruvate],ParameterGroup=Parameters,Parameter=k1" value="1" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Values[kf_\[H\]step1],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Reactions[\[H\] lactic_acid to pyruvate],ParameterGroup=Parameters,Parameter=k2" value="0.01" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Values[kb_\[H\]step1],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Reactions[\[H\]glyconeogenesis]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Reactions[\[H\]glyconeogenesis],ParameterGroup=Parameters,Parameter=k1" value="0.10000000000000001" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Values[kf_\[H\]step2],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Reactions[\[H\]glyconeogenesis],ParameterGroup=Parameters,Parameter=k2" value="0.01" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Reactions[\[S\]pyruvate to lactic_acid]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Reactions[\[S\]pyruvate to lactic_acid],ParameterGroup=Parameters,Parameter=k1" value="100" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Values[kf_\[S\]step2],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Reactions[\[S\]pyruvate to lactic_acid],ParameterGroup=Parameters,Parameter=k2" value="0.01" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Reactions[\[S\]_to_\[H\]]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Glycolysis - ICMB1 exercise,Vector=Reactions[\[S\]_to_\[H\]],ParameterGroup=Parameters,Parameter=k1" value="1" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 6.0221417900000009e+22 1.2044283580000001e+21 0 0 0 0 0 0 6.0221417900000005e+20 0 0 0 0 1.2044283580000001e+21 0 0 0 0 6.0221417900000003e+21 0 1.2044283580000001e+21 6.0221417900000003e+21 6.0221417900000003e+21 6.0221417900000005e+20 6.0221417900000005e+20 6.0221417900000005e+20 6.0221417900000005e+20 6.0221417900000005e+20 6.0221417900000005e+20 6.0221417900000005e+20 6.0221417900000005e+20 6.0221417900000005e+20 6.0221417900000005e+20 6.0221417900000005e+20 6.0221417900000005e+20 1 1 1 1 0.01 1 1 0.01 1 0.01 1 0.01 1 1 0.01 1 0.01 1 0.01 1 0.01 0 0.10000000000000001 0.01 1 0 100 0.01 1 
    </InitialState>
  </Model>
  <ListOfTasks>
